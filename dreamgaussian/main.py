...
class GUI:
    ...
    def seed_everything(self):
        ...
        # seed_everything 함수는 무작위성을 제어하여 코드의 실행 결과를 재현 가능하게 만드는 역할을 합니다. 여기에서 실험적으로 변경하거나 확인해볼 수 있는 주요 포인트를 설명합니다.
    ...
    def prepare_train(self):
        ...
        if self.opt.mvdream or self.opt.imagedream:
            ...
            pose = orbit_camera(self.opt.elevation, 80, self.opt.radius)
        else:
